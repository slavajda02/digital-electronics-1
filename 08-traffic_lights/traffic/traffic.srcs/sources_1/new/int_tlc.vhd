...
entity int_tlc is
  port (
    ...
    sensor_south: in    std_logic; --!West car sensor
    sensor_west : in    std_logic --!South car sensor
    );
end entity int_tlc;
...
architecture behavioral of int_tlc is
...
begin
  ...
  counter <= std_logic_vector(sig_cnt);
